...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_103_beatHit,"GameOverSubstate","beatHit",0xc1b25846,"GameOverSubstate.beatHit","GameOverSubstate.hx",103,0x01fbc1e7)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_122_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",122,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_120_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",120,0x01fbc1e7)

void GameOverSubstate_obj::__construct(Float x,Float y){
            	HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_10_new)
HXLINE( 108)		this->isEnding = false;
...
HXLINE(  27)			this->stageSuffix = HX_("stage",be,6a,0b,84);
HXLINE(  28)			daBf = HX_("bf-holding-gf-DEAD",7f,be,2b,48);
...
HXLINE(  84)		::String daStage = ::PlayState_obj::curStage;
HXLINE(  86)		bool _hx_tmp2;
HXDLIN(  86)		if ((this->bf->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE(  86)			_hx_tmp2 = this->bf->animation->_curAnim->finished;
            		}
            		else {
...
HXDLIN(  88)			_hx_tmp->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOver",66,92,de,b5) + this->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null());
HXLINE(  89)			bool _hx_tmp1;
HXDLIN(  89)			if ((daStage != HX_("warzone",54,f7,be,11))) {
HXLINE(  89)				_hx_tmp1 = (daStage == HX_("warzone-stress",4d,5f,1e,93));
            			}
            			else {
...
HXDLIN(  91)				_hx_tmp->play(::Paths_obj::sound((HX_("jeffGameover-",ec,ac,0b,44) + ::flixel::FlxG_obj::random->_hx_int(1,25,null())),HX_("shared",a5,5e,2b,1d)),null(),null(),null(),null(),null());
            			}
            		}
HXLINE(  95)		if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music->_channel )) {
HXLINE(  97)			::Conductor_obj::songPosition = ::flixel::FlxG_obj::sound->music->_time;
            		}
            	}


void GameOverSubstate_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_b2ae8d30512793fc_103_beatHit)
HXDLIN( 103)		this->super::beatHit();
            	}


void GameOverSubstate_obj::endBullshit(){
            	HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_112_endBullshit)
HXDLIN( 112)		if (!(this->isEnding)) {
            			HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            			void _hx_run( ::flixel::util::FlxTimer tmr){
            				HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            				void _hx_run(){
            					HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_122_endBullshit)
HXLINE( 122)					 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
...
HXLINE( 122)						::flixel::FlxG_obj::game->_requestedState = nextState;
            				...
            				HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_120_endBullshit)
HXLINE( 120)				::flixel::FlxG_obj::camera->fade(-16777216,2,false, ::Dynamic(new _hx_Closure_0()),null());
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 114)			this->isEnding = true;
HXLINE( 115)			this->bf->playAnim(HX_("deathConfirm",2c,44,2b,12),true,null(),null());
HXLINE( 116)			{
HXLINE( 116)				 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN( 116)				_this->cleanup(_this->autoDestroy,true);
            			}
HXLINE( 117)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 117)			::String library = null();
HXDLIN( 117)			_hx_tmp->play(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOverEnd",15,2d,a9,8d) + this->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null(),null(),null());
HXLINE( 118)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.7), ::Dynamic(new _hx_Closure_1()),null());
            		}
            	}
