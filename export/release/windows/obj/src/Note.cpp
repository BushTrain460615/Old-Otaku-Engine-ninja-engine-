...
HXLINE(  45)		this->set_x((this->x + 50));
HXLINE(  47)		this->set_y((this->y - ( (Float)(2000) )));
...
HXLINE( 128)			Float _hx_tmp = this->x;
HXDLIN( 128)			this->set_x((_hx_tmp + (this->get_width() / ( (Float)(2) ))));
...
HXLINE( 144)			Float _hx_tmp1 = this->x;
HXDLIN( 144)			this->set_x((_hx_tmp1 - (this->get_width() / ( (Float)(2) ))));
HXLINE( 146)			if (::StringTools_obj::startsWith(::PlayState_obj::curStage,HX_("school",74,b8,c8,40))) {
HXLINE( 147)				this->set_x((this->x + 30));
            			}
...
HXLINE( 163)				 ::flixel::math::FlxPoint fh = prevNote->scale;
HXDLIN( 163)				fh->set_y((fh->y * (((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.5)) * ( (Float)(::PlayState_obj::SONG->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic)) ))));
