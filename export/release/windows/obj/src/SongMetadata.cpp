...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_311_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",311,0x0d86f62d)
...
HXLINE( 315)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 314)		this->week = 0;
HXLINE( 313)		this->songName = HX_("",00,00,00,00);
HXLINE( 319)		this->songName = song;
HXLINE( 320)		this->week = week;
HXLINE( 321)		this->songCharacter = songCharacter;
            	}
