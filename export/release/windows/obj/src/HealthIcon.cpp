...
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_42_update,"HealthIcon","update",0x767ac302,"HealthIcon.update","HealthIcon.hx",42,0xf7836789)
...
HXLINE(  34)		this->animation->add(HX_("parents-christmas",fe,94,c5,32),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_17,1),0,false,isPlayer,null());
HXLINE(  35)		this->animation->add(HX_("monster",1a,54,b0,b8),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_18,2),0,false,isPlayer,null());
HXLINE(  36)		this->animation->add(HX_("monster-christmas",4f,88,85,27),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_19,2),0,false,isPlayer,null());
...
void HealthIcon_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_42_update)
