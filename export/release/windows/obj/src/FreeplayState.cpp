...
static const ::String _hx_array_data_b3f26131_16[] = {
	HX_("Ugh",b6,d9,40,00),HX_("Guns",13,4e,47,2f),HX_("Stress",54,98,c1,45),
};
static const ::String _hx_array_data_b3f26131_17[] = {
	HX_("tankman",f0,7d,78,3d),HX_("tankman",f0,7d,78,3d),HX_("tankman",f0,7d,78,3d),
};
...
HXLINE(  83)			this->addWeek(::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_16,3),6,::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_17,3));
            		}
...
HXLINE( 167)			songCharacters = ::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_21,1);
            		}
...
HXDLIN( 261)			::haxe::Log_obj::trace((HX_("should have logged: ",b3,75,8c,3a) + HX_("Fresh",4e,f6,b3,99)),::hx::SourceInfo(HX_("source/NGio.hx",4b,1f,9f,05),187,HX_("NGio",5f,e0,c4,33),HX_("logEvent",f6,04,cb,60)));
            		}
