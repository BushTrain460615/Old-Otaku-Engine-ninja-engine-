...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Ninja Engine",18,32,67,eb),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("Ninja Engine",18,32,67,eb));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Ninja Engine",18,32,67,eb));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Ninja Engine",18,32,67,eb));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.urmom.ninja",bd,db,27,63));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Ninja Engine",18,32,67,eb))
