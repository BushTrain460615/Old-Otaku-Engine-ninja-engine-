...
HXLINE(  62)		::haxe::Log_obj::trace(HX_("connecting to newgrounds",49,1b,2e,55),::hx::SourceInfo(HX_("source/NGio.hx",4b,1f,9f,05),62,HX_("NGio",5f,e0,c4,33),HX_("new",60,d0,53,00)));
...
HXLINE(  70)		::haxe::Log_obj::trace(::io::newgrounds::NG_obj::core->attemptingLogin,::hx::SourceInfo(HX_("source/NGio.hx",4b,1f,9f,05),70,HX_("NGio",5f,e0,c4,33),HX_("new",60,d0,53,00)));
HXLINE(  72)		if (::io::newgrounds::NG_obj::core->attemptingLogin) {
HXLINE(  77)			::haxe::Log_obj::trace(HX_("attempting login",fe,74,81,50),::hx::SourceInfo(HX_("source/NGio.hx",4b,1f,9f,05),77,HX_("NGio",5f,e0,c4,33),HX_("new",60,d0,53,00)));
...
HXDLIN(  91)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source/NGio.hx",4b,1f,9f,05),91,HX_("NGio",5f,e0,c4,33),HX_("onNGLogin",31,a7,5b,25)));
...
HXDLIN( 142)		::haxe::Log_obj::trace(HX_("shoulda got score by NOW!",e0,b8,2d,75),::hx::SourceInfo(HX_("source/NGio.hx",4b,1f,9f,05),142,HX_("NGio",5f,e0,c4,33),HX_("onNGBoardsFetch",b5,5d,77,86)));
            	}
...
HXLINE( 187)		::haxe::Log_obj::trace((HX_("should have logged: ",b3,75,8c,3a) + event),::hx::SourceInfo(HX_("source/NGio.hx",4b,1f,9f,05),187,HX_("NGio",5f,e0,c4,33),HX_("logEvent",f6,04,cb,60)));
            	}
