...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Ninja Engine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Ninja Engine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "9";
		app.meta["company"] = "Ninja Engine";
		app.meta["file"] = "Ninja Engine";
		app.meta["name"] = "Ninja Engine";
		app.meta["packageName"] = "com.urmom.ninja";
